...
예를 들면 occurs 라는 영어단어와 succor 는 서로 애너그램 관계에 있는데,
...
두 개의 영어 단어가 주어졌을 때, 두 단어가 서로 애너그램 관계에 있도록 만들기
위해서 제거해야 하는 최소 개수의 문자 수를 구하는 프로그램을 작성하시오.
...
for i in range(97, 123):
    result += abs(String1.count(chr(i)) - String2.count(chr(i)))
