...
if time % five_m % one_m % ten_s == 0:

    if time // five_m > 0:
        five_result = time // five_m
        time = (time - five_m * (time // five_m))
    else:
        five_result = 0

    if time // one_m > 0:
        one_result = time // one_m
        time = (time - one_m * (time // one_m))
    else:
        one_result = 0

    if time // ten_s > 0:
        ten_result = time // ten_s
        time = (time - ten_s * (time // ten_s))
    else:
        ten_result = 0
